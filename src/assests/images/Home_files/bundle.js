...
(() => {
  var t = {
      "./src/website/Scripts/Typescript/data/cntries_lst.ts": (t, e) => {
        "use strict";
      ...
      "./src/website/Scripts/Typescript/helpers/Chart/ChartPosition/position.ts": (
        t,
        e
      ) => {
        "use strict";
        function i(t) {
          ...
          throw new Error(`The html element with id=${t} doesn't exist`);
        }
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.GetDomID = e.GetCtx = void 0),
          (e.GetDomID = i),
          (e.GetCtx = function (t) {
            const e = i(t);
            let s;
            if (!(e instanceof HTMLCanvasElement))
              throw new Error(
                `${t} doesn't appear to be an html canvas element`
              );
            if (
              ((s = e.getContext("2d")), s instanceof CanvasRenderingContext2D)
            )
              return s;
            throw new Error(`${t} doesn't appear to be a canvas`);
          });
      },
      "./src/website/Scripts/Typescript/helpers/Chart/ChartType/initial_config.ts": (
        t,
        e
      ) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.conf = e.googchartconf = void 0);
        e.conf = {
          type: "line",
      ...
      "./src/website/Scripts/Typescript/helpers/Chart/InitChart/ChartConfig.ts": function (
        t,
        e,
        i
      ) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.ChartjsConfig = e.GoogleGeoConfig = void 0);
        const n = i(
            "./src/website/Scripts/Typescript/helpers/filters/clreducer.ts"
          ),
          o = i(
            "./src/website/Scripts/Typescript/helpers/Chart/ChartPosition/position.ts"
          ),
          a = i("../node_modules/chart.js/auto/auto.cjs"),
          r = i(
            "./src/website/Scripts/Typescript/helpers/Chart/ChartType/initial_config.ts"
          ),
          l = i("./src/website/Scripts/Typescript/helpers/tools/utils.ts"),
          h = i(
            "./src/website/Scripts/Typescript/helpers/Chart/UpdateChart/refresher.ts"
          ),
          c = s(i("./src/website/Scripts/Typescript/data/cntries_lst.ts"));
        e.ChartjsConfig = class {
          data;
          ctx;
          con;
          promise;
          constructor(t, e, i) {
            (this.data = t), (this.ctx = (0, o.GetCtx)(i)), (this.con = e);
          }
          SetRefresh(t, e, i) {
            let s = (0, o.GetDomID)(i);
            if ((console.log(s), this.promise)) {
              let i = this;
              var a = {};
              let o;
              s.addEventListener("change", function (s) {
                const r = s.target;
                if (r) {
                  (o = (0, l.isNumber)(r.value) ? r.valueAsNumber : r.value),
                    (a[e] = o);
                  const s = new n.Filter(i.data, a, t).filter();
                  void 0 !== i.promise
                    ? (0, h.Update2DChart)(i.promise, s)
                    : console.log("The promise is undefined");
                }
              });
            } else
              console.log(
                `No Promise at the id ${this.ctx.canvas.id} has been made`
              );
          }
          Set2D(t, e) {
            let i = this.SetAxis(t, e);
            !(function (t, e) {
              const i = e.map((t) => t.x),
                s = e.map((t) => t.y);
              try {
                (t.data.labels = i), (t.data.datasets[0].data = s);
              } catch (e) {
                throw new Error(
                  `${t} could not be updated because labels or datasets or\n          datatests[0].data is unavailable`
                );
              }
            })(this.con, i),
              (this.promise = (async function (t, e) {
                return new a.Chart(t, e);
              })(this.ctx, this.con));
          }
          SetAxis(t, e) {
            return new n.Filter(this.data, t, e).filter();
          }
        };
        e.GoogleGeoConfig = class {
          data;
          options;
          dataconf;
          id_elem;
          ...
          SetTable(t) {
            return (
              ...
              this.data.forEach((e) => {
                const i = {
                  c: [{ v: e.iso, f: c.default[e.iso] }, { v: e[t] }],
                };
                this.dataconf.rows.push(i);
              }),
              this.dataconf
            );
          }
          draw() {
            var t = new google.visualization.GeoChart(
              document.getElementById(this.id_elem)
            );
            console.log(t);
            var e = new google.visualization.DataTable(this.dataconf);
            console.log(e), t.draw(e, this.options);
          }
        };
      },
      "./src/website/Scripts/Typescript/helpers/Chart/UpdateChart/refresher.ts": (
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.Update2DChart = void 0),
          (e.Update2DChart = async function (t, e) {
            const i = e.map((t) => t.x),
              s = e.map((t) => t.y),
              n = await t;
            try {
              (n.data.labels = i), (n.data.datasets[0].data = s), n.update();
            } catch (t) {
              console.log(`${n} could not be updated`);
            }
          });
      },
      "./src/website/Scripts/Typescript/helpers/filters/clreducer.ts": (
        ...
        e.Filter = class {
          ...
          container;
          constructor(t, e, i) {
            (this.data = t), (this.conditions = e), (this.container = i);
          }
          evaluate_conds(t) {
            const e = Object.keys(this.conditions);
            for (let i of e) if (this.conditions[i] != t[i]) return !1;
            return !0;
          }
          myreducer(t, e) {
          ...
          filter() {
            return this.data.reduce(
              (t, e) => (
                this.evaluate_conds(e) &&
                  t.push(this.myreducer(e, this.container)),
                t
              ),
              []
            );
      ...
      "./src/website/Scripts/Typescript/helpers/tools/utils.ts": (t, e, i) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.AppendOption = e.isNumber = void 0);
        const s = i(
          "./src/website/Scripts/Typescript/helpers/Chart/ChartPosition/position.ts"
        );
        (e.isNumber = function (t) {
          ...
          (e.AppendOption = function (t, e) {
            window.addEventListener("load", function () {
              let i = (0, s.GetDomID)(t);
              for (const [t, s] of Object.entries(e)) {
                let e = document.createElement("option");
                (e.textContent = s), (e.value = t), i.appendChild(e);
              }
            });
          });
      },
      "./src/website/Scripts/Typescript/index/LinePlot/config.ts": (
        t,
        e,
        i
      ) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.evol_config = void 0);
        const s = i(
          "./src/website/Scripts/Typescript/helpers/Chart/ChartType/initial_config.ts"
        );
        let n = structuredClone(s.conf);
        e.evol_config = n;
        n.type = "line";
        n.data.datasets = [
          {
        ...
        const o = {
          ...
          scales: {
            x: {
              grid: { color: "white", borderColor: "white", display: !1 },
              ticks: { color: "white", autoSkip: !0, maxTicksLimit: 20 },
            },
            y: {
              grid: { color: "white", borderColor: "white", display: !1 },
              ticks: {
          ...
          plugins: {
            legend: { display: !1, labels: { color: "white", font: 18 } },
          },
        };
        n.options = o;
      },
      "./src/website/Scripts/Typescript/index/doghnut_1/config.ts": (
        t,
        e,
        i
      ) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.dognut_conf_home_1 = void 0);
        const s = i(
          "./src/website/Scripts/Typescript/helpers/Chart/ChartType/initial_config.ts"
        );
        let n = structuredClone(s.conf);
        e.dognut_conf_home_1 = n;
        n.type = "doughnut";
        n.data.datasets = [
          {
            data: [],
        ...
        n.options = {
          ...
          plugins: {
            ...
            title: {
              display: !1,
              text: "Top countries hosting refugees",
              color: "white",
              font: { size: 20 },
            },
          },
      ...
      "./src/website/Scripts/Typescript/index/dognut_2/config.ts": (
        t,
        e,
        i
      ) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.dognut_conf_home_2 = void 0);
        const s = i(
          "./src/website/Scripts/Typescript/helpers/Chart/ChartType/initial_config.ts"
        );
        let n = structuredClone(s.conf);
        e.dognut_conf_home_2 = n;
        n.type = "doughnut";
        n.data.datasets = [
          {
            label: "World",
        ...
        n.options = {
          ...
          plugins: {
            ...
            title: {
              display: !1,
              text: "Top countries having refugees",
              color: "white",
              font: { size: 20 },
            },
          },
      ...
      "./src/website/Scripts/Typescript/index/fpage.ts": function (t, e, i) {
        "use strict";
        var s =
          (this && this.__importDefault) ||
          function (t) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 });
        const n = i(
            "./src/website/Scripts/Typescript/helpers/Chart/InitChart/ChartConfig.ts"
          ),
          o = i("./src/website/Scripts/Typescript/index/doghnut_1/config.ts"),
          a = i("./src/website/Scripts/Typescript/index/LinePlot/config.ts"),
          r = i("./src/website/Scripts/Typescript/index/dognut_2/config.ts"),
          l = i("./src/website/Scripts/Typescript/helpers/tools/utils.ts"),
          h = s(i("./src/website/Scripts/Typescript/data/cntries_lst.ts"));
        (0, l.AppendOption)("select-country", h.default);
        const c = JSON.parse(json_origin);
        new n.ChartjsConfig(c, o.dognut_conf_home_1, "pieplot-1").Set2D(
          {},
          { x: "other", y: "origin_refugees" }
        );
        const d = JSON.parse(json_total_per_year);
        let u = new n.ChartjsConfig(d, a.evol_config, "line-1");
        u.Set2D({ iso_2_: "ALL" }, { x: "year", y: "metric" }),
          u.SetRefresh({ x: "year", y: "metric" }, "iso_2_", "select-country");
        const f = JSON.parse(json_arrivals);
        new n.ChartjsConfig(f, r.dognut_conf_home_2, "pieplot-2").Set2D(
          {},
          { x: "other", y: "arrival_refugees" }
        );
      },
      "../node_modules/@kurkle/color/dist/color.cjs": function (t) {
        t.exports = (function () {
          "use strict";
          function t(t) {
            return (t + 0.5) | 0;
                ...
                (4 === i || 5 === i
                  ...
                  : (7 !== i && 9 !== i) ||
                    (e = {
                      ...
                      g: (r[t[3]] << 4) | r[t[4]],
                      b: (r[t[5]] << 4) | r[t[6]],
                      a: 9 === i ? (r[t[7]] << 4) | r[t[8]] : 255,
                    })),
              e
            );
          }
          const g = (t, e) => (t < 255 ? e(t) : "");
          function p(t) {
            var e = u(t) ? h : c;
            return t ? "#" + e(t.r) + e(t.g) + e(t.b) + g(t.a, e) : void 0;
          }
          const m = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
          function b(t, e, i) {
          ...
          function W(t) {
            ...
            return (
              Array.isArray(t)
                ...
                : ((e = H(t, { r: 0, g: 0, b: 0, a: 1 })).a = n(e.a)),
              e
            );
          }
          function U(t) {
            return "r" === t.charAt(0) ? F(t) : C(t);
          }
          class $ {
            constructor(t) {
            ...
            interpolate(t, e) {
              return t && (this._rgb = V(this._rgb, t._rgb, e)), this;
            }
            clone() {
              return new $(this.rgb);
            }
      ...
      "../node_modules/chart.js/auto/auto.cjs": (t, e, i) => {
        const s = i("../node_modules/chart.js/dist/chart.cjs"),
          { Chart: n, registerables: o } = s;
        n.register(...o), (t.exports = Object.assign(n, s));
      },
      "../node_modules/chart.js/dist/chart.cjs": (t, e, i) => {
        "use strict";
        var s = i("../node_modules/chart.js/dist/chunks/helpers.segment.cjs");
        i("../node_modules/@kurkle/color/dist/color.cjs");
        class n {
          constructor() {
            (this._request = null),
        ...
        class h {
          ...
          configure(t) {
            ...
            Object.getOwnPropertyNames(t).forEach((n) => {
              const o = t[n];
              if (!s.isObject(o)) return;
              const a = {};
              for (const t of e) a[t] = o[t];
              ((s.isArray(o.properties) && o.properties) || [n]).forEach(
                (t) => {
        ...
        class v {
          ...
          buildOrUpdateElements(t) {
            ...
            (e._stacked = f(e.vScale, e)),
              e.stack !== i.stack && ((s = !0), x(e), (e.stack = i.stack)),
          ...
          parse(t, e) {
            ...
            if (!1 === this._parsing)
              ...
              for (l = 0; l < e; ++l)
                (i._parsed[l + t] = h = c[l]), d && (o() && (d = !1), (u = h));
              i._sorted = d;
            }
            a && m(this, c);
          }
          ...
          applyStack(t, e, i) {
            const s = this.chart,
              ...
              o = e[t.axis];
            return u(
              { keys: d(s, !0), values: e._stacks[t.axis]._visualValues },
              o,
              n.index,
              { mode: i }
            );
          ...
          getMinMax(t, e) {
            const i = this._cachedMeta,
              ...
              l = ((t, e, i) =>
                t &&
                !e.hidden &&
                e._stacked && { keys: d(i, !0), values: null })(
                e,
                i,
                this.chart
              ),
            ...
            for (
              f = 0;
              f < a && (p() || (this.updateRangeFromParsed(h, t, g, l), !o));
              ++f
            );
            if (o)
              for (f = a - 1; f >= 0; --f)
          ...
          getAllParsedValues(t) {
            ...
            for (n = 0, o = e.length; n < o; ++n)
              (a = e[n][t.axis]), s.isNumberFinite(a) && i.push(a);
            return i;
          }
          getMaxOverflow() {
            return !1;
          ...
          _resolveElementOptions(t, e = "default", i) {
            ...
            return (
              g.$shared && ((g.$shared = l), (o[a] = Object.freeze(y(g, l)))), g
            );
          }
        ...
        function M(t) {
          ...
          const h = () => {
            32767 !== a &&
              -32768 !== a &&
              (s.defined(r) && (l = Math.min(l, Math.abs(a - r) || l)),
              (r = a));
          };
          for (n = 0, o = i.length; n < o; ++n)
            (a = e.getPixelForValue(i[n])), h();
          for (r = void 0, n = 0, o = e.ticks.length; n < o; ++n)
            (a = e.getPixelForTick(n)), h();
          return l;
        }
        function w(t, e, i, n) {
          return (
        ...
        function D(t, { inflateAmount: e }, i) {
          ...
          parseObjectData(t, e, i, n) {
            ...
            for (u = i, f = i + n; u < f; ++u)
              (p = e[u]),
                ...
                d.push(w(s.resolveObjectKey(p, c), g, a, u));
            return d;
          }
          updateRangeFromParsed(t, e, i, s) {
            ...
            for (let f = e; f < e + i; f++) {
              const e = this.getParsed(f),
                ...
                m = {
                  ...
                  base: i.base,
                  enableBorderRadius:
                    !p || k(e._custom) || a === p._top || a === p._bottom,
                  x: h ? i.head : g.center,
                  y: h ? g.center : i.head,
            ...
            const { iScale: i } = this._cachedMeta,
              ...
              r = (t) => {
                const i = t.controller.getParsed(e),
                  n = i && i[t.vScale.axis];
                if (s.isNullOrUndef(n) || isNaN(n)) return !0;
              };
            for (const i of n)
              if (
                (void 0 === e || !r(i)) &&
        ...
        class L extends v {
          ...
          update(t) {
            const e = this.chart,
              ...
              { ratioX: u, ratioY: f, offsetX: g, offsetY: p } = (function (
                t,
                e,
                i
              ) {
              ...
              y =
                (_ - Math.max(_ * l, 0)) / this._getVisibleDatasetWeightTotal();
            (this.offsetX = g * _),
              (this.offsetY = p * _),
              (n.total = this.calculateTotal()),
              (this.outerRadius =
                _ - y * this._getRingWeightOffset(this.index)),
          ...
          _circumference(t, e) {
            ...
            return (e && i.animation.animateRotate) ||
              ...
              n.data[t].hidden
              ? 0
              : this.calculateCircumference((n._parsed[t] * o) / s.TAU);
          }
          updateElements(t, e, i, s) {
            const n = "reset" === s,
              o = this.chart,
          ...
          _getRingWeight(t) {
            return Math.max(
              s.valueOrDefault(this.chart.data.datasets[t].weight, 1),
              0
            );
          }
        ...
        class R extends v {
          ...
          update(t) {
            ...
            let { start: r, count: l } = s._getStartAndCountOfVisiblePoints(
              e,
              n,
              a
            );
            (this._drawStart = r),
              (this._drawCount = l),
              s._scaleRangesChanged(e) && ((r = 0), (l = n.length)),
              (i._chart = this.chart),
            ...
            this.options.showLine || (h.borderWidth = 0),
              ...
              this.updateElement(i, void 0, { animated: !a, options: h }, t),
        ...
        class E extends v {
          ...
          updateElements(t, e, i, n) {
            const o = "reset" === n,
              ...
              h = l.xCenter,
              c = l.yCenter,
              d = l.getIndexAngle(0) - 0.5 * s.PI;
            let u,
              f = d;
            const g = 360 / this.countVisibleElements();
            for (u = 0; u < e; ++u) f += this._computeAngle(u, n, g);
            for (u = e; u < e + i; u++) {
              const e = t[u];
              let i = f,
                s = f + this._computeAngle(u, n, g),
                p = a.getDataVisibility(u)
                  ? l.getDistanceFromCenterForValue(this.getParsed(u).r)
                  : 0;
              (f = s),
                o &&
                  (r.animateScale && (p = 0), r.animateRotate && (i = s = d));
              const m = {
                x: h,
                y: c,
                innerRadius: 0,
          ...
          _computeAngle(t, e, i) {
            return this.chart.getDataVisibility(t)
              ? s.toRadians(this.resolveDataElementOptions(t, e).angle || i)
              : 0;
          }
        }
        class I extends L {
        ...
        class N extends v {
          ...
          update(t) {
            ...
            let { start: o, count: a } = s._getStartAndCountOfVisiblePoints(
              e,
              i,
              n
            );
            if (
              ((this._drawStart = o),
              (this._drawCount = a),
              s._scaleRangesChanged(e) && ((o = 0), (a = i.length)),
          ...
          addElements() {
            ...
            !this.datasetElementType &&
              t &&
              (this.datasetElementType = this.chart.registry.getElement(
                "line"
              )),
              super.addElements();
          }
        ...
        function U(t, e, i, n, o) {
          ...
          return (
            W(
              ...
              e,
              function (i, r, l) {
                (o || s._isPointInArea(i, t.chartArea, 0)) &&
                  i.inRange(e.x, e.y, n) &&
                  a.push({ element: i, datasetIndex: r, index: l });
              },
              !0
            ),
            a
        ...
        var K = {
          evaluateInteractionItems: W,
          modes: {
            index(t, e, i, n) {
              const o = s.getRelativePosition(e, t),
                a = i.axis || "x",
                r = i.includeInvisible || !1,
                l = i.intersect ? U(t, o, a, n, r) : G(t, o, a, !1, n, r),
                h = [];
              return l.length
            ...
            dataset(t, e, i, n) {
              const o = s.getRelativePosition(e, t),
                a = i.axis || "xy",
                r = i.includeInvisible || !1;
              let l = i.intersect ? U(t, o, a, n, r) : G(t, o, a, !1, n, r);
              if (l.length > 0) {
            ...
            nearest(t, e, i, n) {
              const o = s.getRelativePosition(e, t),
                a = i.axis || "xy",
                r = i.includeInvisible || !1;
              return G(t, o, a, i.intersect, n, r);
            },
            x: (t, e, i, n) =>
              Y(t, s.getRelativePosition(e, t), "x", i.intersect, n),
            y: (t, e, i, n) =>
              Y(t, s.getRelativePosition(e, t), "y", i.intersect, n),
          },
        };
        ...
        function at(t, e, i, n) {
          ...
          for (const l of t) {
            const t = l.box,
              h = n[l.stack] || { count: 1, placed: 0, weight: 1 },
            ...
            if (l.horizontal) {
              ...
              s.defined(h.start) && (r = h.start),
                t.fullSize
                  ? ot(t, o.left, r, i.outerWidth - o.right - o.left, a)
                  : ot(t, e.left + h.placed, r, n, a),
                (h.start = r),
                (h.placed += n),
                (r = t.bottom);
            } else {
              ...
              s.defined(h.start) && (a = h.start),
                t.fullSize
                  ? ot(t, a, o.top, r, i.outerHeight - o.bottom - o.top)
                  : ot(t, a, e.top + h.placed, r, n),
                (h.start = a),
                (h.placed += n),
                (a = t.right);
            }
        ...
        var rt = {
          ...
          update(t, e, i, n) {
            ...
            const g = Object.assign(
                { maxPadding: f, w: a, h: r, x: o.left, y: o.top },
                o
              ),
              p = Q(h.concat(c), u);
            nt(l.fullSize, g, u, p),
        ...
        const ct = "$chartjs",
          ...
          ut = (t) => null === t || "" === t;
        const ft = !!s.supportsEventListenerOptions && { passive: !0 };
        function gt(t, e, i) {
        ...
        function vt(t, e, i) {
          ...
          return (
            r.observe(o),
            (function (t, e) {
              xt.size || window.addEventListener("resize", yt), xt.set(t, e);
            })(t, a),
            r
          );
        }
        ...
        class St extends lt {
          ...
          addEventListener(t, e, i) {
            ...
            const s = t.$proxies || (t.$proxies = {}),
              n = { attach: mt, detach: bt, resize: vt }[e] || wt;
            s[e] = n(t, e, i);
          }
          removeEventListener(t, e) {
            const i = t.$proxies || (t.$proxies = {}),
              s = i[e];
            if (!s) return;
            (({ attach: Mt, detach: Mt, resize: Mt }[e] || gt)(t, e, s),
              (i[e] = void 0));
          }
          getDevicePixelRatio() {
        ...
        function Ct(t, e) {
          ...
          if (r > 0) {
            ...
            for (
              Ot(e, c, d, s.isNullOrUndef(n) ? 0 : l - n, l), t = 0, i = r - 1;
              t < i;
              t++
            )
              Ot(e, c, d, a[t], a[t + 1]);
            return Ot(e, c, d, h, s.isNullOrUndef(n) ? e.length : h + n), c;
          }
          return Ot(e, c, d), c;
        }
        function Ot(t, e, i, n, o) {
          ...
          for (h = Math.max(a, 0); h < r; h++)
            h === c && (e.push(t[h]), d++, (c = Math.round(a + d * i)));
        }
        const Dt = (t) => ("left" === t ? "right" : "right" === t ? "left" : t),
          At = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i),
          Tt = (t, e) => Math.min(e || t, t);
        function Lt(t, e) {
          const i = [],
            s = t.length / e,
            n = t.length;
        ...
        function It(t, e) {
          ...
          return (
            (s.isArray(t.text) ? t.text.length : 1) * i.lineHeight + n.height
          );
        }
        function Ft(t, e, i) {
          let n = s._toLeftRightCenter(t);
          return (
            ((i && "right" !== e) || (!i && "right" === e)) && (n = Dt(n)), n
          );
        }
        class Nt extends Pt {
          constructor(t) {
          ...
          getUserBounds() {
            ...
            return (
              (t = s.finiteOrDefault(t, Number.POSITIVE_INFINITY)),
          ...
          update(t, e, i) {
            ...
            this._convertTicksToLabels(l ? Lt(this.ticks, r) : this.ticks),
              this.configure(),
          ...
          calculateLabelRotation() {
            const t = this.options,
              e = t.ticks,
              i = Tt(this.ticks.length, t.ticks.maxTicksLimit),
              n = e.minRotation || 0,
              o = e.maxRotation;
            let a,
              r,
            ...
            (a = t.offset ? this.maxWidth / i : f / (i - 1)),
              d + 6 > a &&
                ...
                (r =
                  ...
                  Et(t.grid) -
                  e.padding -
                  It(t.title, this.chart.options.font)),
                (l = Math.sqrt(d * d + u * u)),
                (h = s.toDegrees(
                  Math.min(
                    Math.asin(s._limitValue((c.highest.height + 6) / a, -1, 1)),
                    Math.asin(s._limitValue(r / l, -1, 1)) -
                      Math.asin(s._limitValue(u / l, -1, 1))
                  )
                )),
          ...
          fit() {
            const t = { width: 0, height: 0 },
              ...
              r = this.isHorizontal();
            if (a) {
              const a = It(n, e.options.font);
              if (
                (r
                  ? ((t.width = this.maxWidth), (t.height = Et(o) + a))
                  : ((t.height = this.maxHeight), (t.width = Et(o) + a)),
          ...
          _convertTicksToLabels(t) {
            ...
            for (
              ...
              s.isNullOrUndef(t[e].label) && (t.splice(e, 1), i--, e--);
                ...
                if (s.isArray(u))
                  for (c = 0, d = u.length; c < d; ++c)
                    (_ = u[c]),
                      s.isNullOrUndef(_) ||
                        s.isArray(_) ||
                        ((b = s._measureText(n, p.data, p.gc, b, _)), (x += m));
              } else (b = s._measureText(n, p.data, p.gc, b, u)), (x = m);
          ...
          getPixelForDecimal(t) {
            ...
            return s._int16Range(
              this._alignToPixels ? s._alignPixel(this.chart, e, 0) : e
            );
          }
          ...
          getContext(t) {
            ...
            return (
              ...
              (this.$context =
                ...
                (n = this),
                s.createContext(i, { scale: n, type: "scale" })))
            );
            var i, n;
          }
          _tickSize() {
          ...
          _computeGridLineItems(t) {
            ...
            if ("top" === a)
              ...
              (P = t.top), (O = t.bottom), (M = b + p), (S = M + d);
            } else if ("y" === e) {
              ...
              (v = b - p), (w = v - d), (k = t.left), (C = t.right);
            }
            const D = s.valueOrDefault(n.ticks.maxTicksLimit, c),
              A = Math.max(1, Math.ceil(c / D));
            for (x = 0; x < c; x += A) {
              ...
              (_ = Rt(this, x, l)),
                void 0 !== _ &&
                  ((y = s._alignPixel(i, _, a)),
                  h ? (v = w = k = C = y) : (M = S = P = O = y),
                  u.push({
                    tx1: v,
                    ty1: M,
                    tx2: w,
          ...
          _computeLabelItems(t) {
            ...
            if ("top" === n)
              ...
              if ("center" === n) M = (t.top + t.bottom) / 2 + f;
              ...
              if ("center" === n) v = (t.left + t.right) / 2 - f;
              else if (s.isObject(n)) {
                const t = Object.keys(n)[0],
                  e = n[t];
          ...
          drawBorder() {
            ...
            let h, c, d, u;
            this.isHorizontal()
              ? ((h = s._alignPixel(t, this.left, a) - a / 2),
                (c = s._alignPixel(t, this.right, r) + r / 2),
                (d = u = l))
              : ((d = s._alignPixel(t, this.top, a) - a / 2),
          ...
          drawTitle() {
            ...
            "bottom" === e || "center" === e || s.isObject(e)
              ? ((l += a.bottom),
                s.isArray(i.text) && (l += o.lineHeight * (i.text.length - 1)))
              : (l += a.top);
            const {
              titleX: h,
              titleY: c,
              ...
              const m = r - o,
                b = l - a;
              if (t.isHorizontal()) {
                if (((f = s._alignStartEnd(n, a, l)), s.isObject(i))) {
        ...
        class Bt {
          ...
          register(t) {
            ...
            return (
              o in n ||
                ((n[o] = t),
                (function (t, e, i) {
                  const n = s.merge(Object.create(null), [
                    i ? s.defaults.get(i) : {},
                    s.defaults.get(e),
                    t.defaults,
                  ]);
          ...
          unregister(t) {
            ...
            i in e && delete e[i],
              n &&
                i in s.defaults[n] &&
                (delete s.defaults[n][i],
                this.override && delete s.overrides[i]);
          }
        }
        class zt {
          constructor() {
            (this.controllers = new Bt(v, "datasets", !0)),
              (this.elements = new Bt(Pt, "elements")),
              (this.plugins = new Bt(Object, "plugins")),
              (this.scales = new Bt(Nt, "scales")),
          ...
          _notify(t, e, i, n) {
            ...
            for (const o of t) {
              const t = o.plugin,
                a = t[i],
                r = [e, n, o.options];
              if (!1 === s.callback(a, r, t) && n.cancelable) return !1;
            }
            return !0;
          }
          invalidate() {
            s.isNullOrUndef(this._cache) ||
              ...
              ? (function (t, { plugins: e, localIds: i }, s, n) {
                  ...
                  for (const r of e) {
                    ...
                    null !== l &&
                      o.push({
                        plugin: r,
                        options: Wt(t.config, { plugin: r, local: i[e] }, l, a),
                      });
                  }
                  return o;
                })(t, o, n, e)
        ...
        function Wt(t, { plugin: e, local: i }, s, n) {
          ...
          if (
            (t =
              ...
              ("top" === (i = e.position) || "bottom" === i
                ...
                ? "y"
                : void 0) ||
              (t.length > 1 && $t(t[0].toLowerCase(), e)))
          )
            return t;
          throw new Error(
        ...
        function Gt(t) {
          ...
          (e.plugins = s.valueOrDefault(e.plugins, {})),
            (e.scales = (function (t, e) {
              const i = s.overrides[t.type] || { scales: {} },
                n = e.scales || {},
                o = Ut(t.type, e),
        ...
        function qt(t, e) {
          let i = Kt.get(t);
          return i || ((i = e()), Kt.set(t, i), Xt.add(i)), i;
        }
        const Zt = (t, e, i) => {
        ...
        class Jt {
          constructor(t) {
            (this._config = (function (t) {
              return ((t = t || {}).data = Yt(t.data)), Gt(t), t;
            })(t)),
          ...
          update() {
            ...
            this.clearCache(), Gt(t);
          }
          clearCache() {
            this._scopeCache.clear(), this._resolverCache.clear();
          }
          datasetScopeKeys(t) {
            return qt(t, () => [[`datasets.${t}`, ""]]);
          }
          ...
          getOptionScopes(t, e, i) {
            ...
            const l = new Set();
            e.forEach((e) => {
              t && (l.add(t), e.forEach((e) => Zt(l, t, e))),
                e.forEach((t) => Zt(l, n, t)),
                e.forEach((t) => Zt(l, s.overrides[o] || {}, t)),
                e.forEach((t) => Zt(l, s.defaults, t)),
                e.forEach((t) => Zt(l, s.descriptors, t));
            });
              ...
              (function (t, e) {
                ...
                for (const o of e) {
                  const e = i(o),
                    a = n(o),
                    r = (a || e) && t[o];
                  if ((e && (s.isFunction(r) || te(r))) || (a && s.isArray(r)))
                    return !0;
                }
                return !1;
              })(a, e)
            ) {
              (o.$shared = !1), (i = s.isFunction(i) ? i() : i);
        ...
        const te = (t) =>
          ...
          Object.getOwnPropertyNames(t).reduce(
            (e, i) => e || s.isFunction(t[i]),
            !1
          );
        const ee = ["top", "bottom", "left", "right", "chartArea"];
        function ie(t, e) {
          return (
            "top" === t || "bottom" === t || (-1 === ee.indexOf(t) && "x" === e)
          );
        }
        function se(t, e) {
          return function (i, s) {
        ...
        function ne(t) {
          ...
          e.notifyPlugins("afterRender"), s.callback(i && i.onComplete, [t], e);
        }
        function oe(t) {
          const e = t.chart,
            i = e.options.animation;
        ...
        function ae(t) {
          return (
            s._isDomSupported() && "string" == typeof t
        ...
        class ce {
          ...
          constructor(t, e) {
            ...
            const r = i.createResolver(
              i.chartOptionScopes(),
              this.getContext()
            );
            (this.platform = new (i.platform || kt(n))()),
            ...
            (this.id = s.uid()),
              ...
              (re[this.id] = this),
              l && h
                ? (o.listen(this, "complete", ne),
                  o.listen(this, "progress", oe),
                  this._initialize(),
          ...
          _initialize() {
            return (
              ...
              this.options.responsive
                ? this.resize()
                : s.retinaScale(this, this.options.devicePixelRatio),
              this.bindEvents(),
          ...
          clear() {
            return s.clearCanvas(this.canvas, this.ctx), this;
          }
          stop() {
          ...
          buildOrUpdateScales() {
            ...
            e &&
              ...
              s.each(o, (e) => {
                ...
                (void 0 !== o.position &&
                  ie(o.position, r) === ie(e.dposition)) ||
                  (o.position = e.dposition),
                  (n[a] = !0);
                let h = null;
                if (a in i && i[a].type === l) h = i[a];
                else {
                  (h = new (Vt.getScale(l))({
                    id: a,
                    type: l,
              ...
              s.each(i, (t) => {
                rt.configure(this, t, t.options), rt.addBox(this, t);
              });
          }
          _updateMetasets() {
            ...
            this._sortedMetasets = t.slice(0).sort(se("order", "index"));
          }
          ...
          buildOrUpdateControllers() {
            ...
            for (
              ...
              if (
                ...
                (o.type = a),
                (o.indexAxis = n.indexAxis || Ut(a, this.options)),
                (o.order = n.order || 0),
                (o.index = i),
                (o.label = "" + n.label),
                ...
                const e = Vt.getController(a),
                  {
                    ...
                    dataElementType: r,
                  } = s.defaults.datasets[a];
                Object.assign(e, {
                  dataElementType: Vt.getElement(r),
                  datasetElementType: n && Vt.getElement(n),
                }),
          ...
          _getUniformDataChanges() {
            ...
            const e = this.data.datasets.length,
              ...
              n = i(0);
            for (let t = 1; t < e; t++) if (!s.setsEqual(n, i(t))) return;
            return Array.from(n)
              .map((t) => t.split(","))
          ...
          _updateDatasets(t) {
            if (
              ...
              for (let e = 0, i = this.data.datasets.length; e < i; ++e)
                this._updateDataset(
                  e,
                  s.isFunction(t) ? t({ datasetIndex: e }) : t
                );
          ...
          getContext() {
            return (
              this.$context ||
              (this.$context = s.createContext(null, {
                chart: this,
                type: "chart",
              }))
            );
          ...
          _stop() {
            let t, e;
            for (
              this.stop(), o.remove(this), t = 0, e = this.data.datasets.length;
              t < e;
              ++t
            )
        ...
        function de() {
          return s.each(ce.instances, (t) => t._plugins.invalidate());
        }
        function ue(t, e, i, n) {
          const o =
            ((a = t.options.borderRadius),
            s._readValueToProps(a, [
              "outerStart",
              "outerEnd",
              "innerStart",
              "innerEnd",
        ...
        function ge(t, e, i, n, o, a) {
          ...
          const m = (p - Math.max(0.001, p * u - i / s.PI) / u) / 2,
            b = h + m + g,
            x = o - m - g,
            { outerStart: _, outerEnd: y, innerStart: v, innerEnd: M } = ue(
              e,
              f,
              u,
              x - b
          ...
          if ((t.beginPath(), a)) {
            const e = (k + P) / 2;
            if ((t.arc(r, l, u, k, e), t.arc(r, l, u, e, P), y > 0)) {
              const e = fe(S, P, r, l);
              t.arc(e.x, e.y, y, P, x + s.HALF_PI);
            }
            const i = fe(O, x, r, l);
            if ((t.lineTo(i.x, i.y), M > 0)) {
              const e = fe(O, A, r, l);
              t.arc(e.x, e.y, M, x + s.HALF_PI, A + Math.PI);
            }
            const n = (x - M / f + (b + v / f)) / 2;
            if (
              (t.arc(r, l, f, x - M / f, n, !0),
              t.arc(r, l, f, n, b + v / f, !0),
              v > 0)
            ) {
              const e = fe(C, D, r, l);
              t.arc(e.x, e.y, v, D + Math.PI, b - s.HALF_PI);
            }
            const o = fe(w, b, r, l);
            if ((t.lineTo(o.x, o.y), _ > 0)) {
              const e = fe(w, k, r, l);
              t.arc(e.x, e.y, _, b - s.HALF_PI, k);
            }
          } else {
            t.moveTo(r, l);
            const e = Math.cos(k) * u + r,
              i = Math.sin(k) * u + l;
            t.lineTo(e, i);
          ...
          u &&
            (function (t, e, i) {
              ...
              t.beginPath(),
                t.arc(a, r, l, n - c, i + c),
                h > o
                  ? ((c = o / h), t.arc(a, r, h, i + c, n - c, !0))
                  : t.arc(a, r, o, i + s.HALF_PI, n - s.HALF_PI),
                t.closePath(),
                t.clip();
            })(t, e, f),
            a || (ge(t, e, i, n, f, o), t.stroke());
        }
        class me extends Pt {
          static id = "arc";
          static defaults = {
          ...
          inRange(t, e, i) {
            const n = this.getProps(["x", "y"], i),
              ...
              f =
                s.valueOrDefault(d, l - r) >= s.TAU || s._angleBetween(o, r, l),
        ...
        function be(t, e, i = e) {
          (t.lineCap = s.valueOrDefault(i.borderCapStyle, e.borderCapStyle)),
            ...
            (t.lineDashOffset = s.valueOrDefault(
              i.borderDashOffset,
              e.borderDashOffset
            )),
            (t.lineJoin = s.valueOrDefault(
              i.borderJoinStyle,
              e.borderJoinStyle
            )),
        ...
        function ye(t, e, i, n) {
          const { points: o, options: a } = e,
            { count: r, start: l, loop: h, ilen: c } = _e(o, i, n),
            d = (function (t) {
              return t.stepped
                ? s._steppedLineTo
          ...
          let u,
            f,
            g,
            { move: p = !0, reverse: m } = n || {};
          for (u = 0; u <= c; ++u)
            (f = o[(l + (m ? c - u : u)) % r]),
              f.skip ||
                (p ? (t.moveTo(f.x, f.y), (p = !1)) : d(t, g, f, m, a.stepped),
                (g = f));
          return (
            h && ((f = o[(l + (m ? c : 0)) % r]), d(t, g, f, m, a.stepped)), !!h
          );
        }
        function ve(t, e, i, s) {
          const n = e.points,
            { count: o, start: a, ilen: r } = _e(n, i, s),
        ...
        class ke extends Pt {
          ...
          get segments() {
            return (
              this._segments ||
              (this._segments = s._computeSegments(this, this.options.segment))
            );
          }
          first() {
          ...
          interpolate(t, e) {
            const i = this.options,
              n = t[e],
              o = this.points,
              a = s._boundSegments(this, { property: e, start: n, end: n });
            if (!a.length) return;
            const r = [],
              l = (function (t) {
                return t.stepped
                  ? s._steppedInterpolation
                  : t.tension || "monotone" === t.cubicInterpolationMode
                  ? s._bezierInterpolation
                  : s._pointInLine;
              })(i);
            let h, c;
          ...
          draw(t, e, i, s) {
            ...
            (this.points || []).length &&
              n.borderWidth &&
              (t.save(), Se(t, this, i, s), t.restore()),
              this.animated &&
        ...
        class Ce extends Pt {
          ...
          draw(t, e) {
            ...
            this.skip ||
              i.radius < 0.1 ||
              !s._isPointInArea(this, e, this.size(i) / 2) ||
        ...
        function Te(t, e, i, n) {
          ...
          return (
            r &&
            (o || s._isBetween(e, r.left, r.right)) &&
            (a || s._isBetween(i, r.top, r.bottom))
          );
        }
        function Le(t, e) {
        ...
        class Ee extends Pt {
          ...
          inRange(t, e, i) {
            return Te(this, t, e, i);
          }
          inXRange(t, e) {
            return Te(this, t, null, e);
          }
          inYRange(t, e) {
        ...
        const Fe = [
          ...
          Ne = Fe.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
        function Be(t) {
        ...
        function Ve(t) {
          ...
          return (i, s) => {
            ...
            n instanceof L
              ? (e = (function (t, e) {
                  return (t.backgroundColor = t.data.map(() => Be(e++))), e;
                })(i, e))
              : n instanceof E
              ? (e = (function (t, e) {
                  return (t.backgroundColor = t.data.map(() => ze(e++))), e;
                })(i, e))
              : n &&
                (e = (function (t, e) {
                  return (
                    (t.borderColor = Be(e)), (t.backgroundColor = ze(e)), ++e
                  );
                })(i, e));
          };
        }
        ...
        var $e = {
          ...
          beforeElementsUpdate: (t, e, i) => {
            if (!i.enabled) return void Ue(t);
            const n = t.width;
            t.data.datasets.forEach((e, o) => {
              const { _data: a, indexAxis: r } = e,
                l = t.getDatasetMeta(o),
                h = a || e.data;
              if ("y" === s.resolve([r, t.options.indexAxis])) return;
              ...
              let { start: d, count: u } = (function (t, e) {
                ...
                return (
                  h &&
                    (o = s._limitValue(
                      s._lookupByKey(e, a.axis, r).lo,
                      0,
                      i - 1
                    )),
                  (n = c
                    ? s._limitValue(s._lookupByKey(e, a.axis, l).hi + 1, o, i) -
                      o
                    : i - o),
                  { start: o, count: n }
                );
              })(l, h);
              if (u <= (i.threshold || 4 * n)) return void We(e);
              let f;
              switch (
                (s.isNullOrUndef(a) &&
                  ((e._data = h),
        ...
        function Ge(t, e, i, n) {
          ...
          return (
            "angle" === t &&
              ((o = s._normalizeAngle(o)), (a = s._normalizeAngle(a))),
        ...
        function Ze(t, e, i) {
          ...
          for (; !1 !== n && -1 === o.indexOf(n); ) {
            if (!s.isNumberFinite(n)) return n;
            if (((a = t[n]), !a)) return !1;
        ...
        function Je(t, e, i) {
          ...
          if (s.isObject(n)) return !isNaN(n.value) && n;
          let o = parseFloat(n);
          return s.isNumberFinite(o) && Math.floor(o) === o
            ? (function (t, e, i, s) {
                ("-" !== t && "+" !== t) || (i = e + i);
        ...
        function Qe(t, e, i) {
          ...
          for (let n = 0; n < i.length; n++) {
            const o = i[n],
              { first: a, last: r, point: l } = ti(o, e, "x");
            if (!(!l || (a && r)))
              if (a) s.unshift(l);
        ...
        function ii(t) {
          ...
          if ("stack" === i)
            return (function (t) {
              ...
              r.push(Xe({ x: null, y: e.bottom }, s));
              for (let t = 0; t < o.length; t++) {
                const e = o[t];
                for (let t = e.start; t <= e.end; t++) Qe(n, a[t], r);
              }
          ...
          return o instanceof ei ? o : Xe(o, n);
        }
        function si(t, e, i) {
          const n = ii(e),
            ...
            (function (t, e) {
              ...
              t.save(),
                "x" === l &&
                  ...
                  t.save(),
                  ni(t, s, a.bottom));
              oi(t, { line: i, target: s, color: o, scale: r, property: l }),
                t.restore();
            })(t, {
              line: o,
              target: n,
          ...
          const { line: i, target: n, property: o, color: a, scale: r } = e,
            l = (function (t, e, i) {
              ...
              for (const t of n) {
                let { start: n, end: l } = t;
                l = Ye(n, l, o);
                const h = Ge(i, o[n], o[l], t.loop);
                if (!e.segments) {
                  r.push({ source: t, target: h, start: o[n], end: o[l] });
                  continue;
                }
                const c = s._boundSegments(e, h);
                for (const e of c) {
                  const n = Ge(i, a[e.start], a[e.end], e.loop),
                    l = s._boundSegment(t, o, n);
                  for (const t of l)
                    r.push({
                      source: t,
                      target: e,
                      start: { [i]: Ke(h, n, "start", Math.max) },
                      end: { [i]: Ke(h, n, "end", Math.min) },
                    });
                }
              }
              return r;
        ...
        var li = {
          ...
          afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
              (l = n[a]),
                l && !1 !== l.fill && (l.fill = Ze(n, a, i.propagate));
          },
          beforeDraw(t, e, i) {
        ...
        class ci extends Pt {
          ...
          fit() {
            ...
            const i = t.labels,
              ...
              { boxWidth: r, itemHeight: l } = hi(i, o);
            let h, c;
            (e.font = n.string),
              this.isHorizontal()
                ? ((h = this.maxWidth), (c = this._fitRows(a, o, r, l) + 10))
                : ((c = this.maxHeight), (h = this._fitCols(a, n, r, l) + 10)),
          ...
          draw() {
            if (this.options.display) {
              const t = this.ctx;
              s.clipArea(t, this), this._draw(), s.unclipArea(t);
            }
          }
          _draw() {
            ...
            this.drawTitle(),
              ...
              (n.lineWidth = 0.5),
              (n.font = h.string);
            const { boxWidth: g, boxHeight: p, itemHeight: m } = hi(a, d),
              b = this.isHorizontal(),
            ...
            this.legendItems.forEach((y, v) => {
              ...
              const M = n.measureText(y.text).width,
                w = l.textAlign(y.textAlign || (y.textAlign = a.textAlign)),
                S = g + u + M;
              let k = f.x,
                P = f.y;
              ...
              if (
                ((function (t, e, i) {
                  ...
                  if (
                    ((n.fillStyle = s.valueOrDefault(i.fillStyle, r)),
                ...
                (k = s._textX(w, k + g + u, b ? k + S : this.right, t.rtl)),
                (function (t, e, i) {
          ...
          _getLegendItemAt(t, e) {
            let i, n, o;
            if (
              s._isBetween(t, this.left, this.right) &&
              s._isBetween(e, this.top, this.bottom)
            )
              for (o = this.legendHitBoxes, i = 0; i < o.length; ++i)
                if (
                  ((n = o[i]),
                  s._isBetween(t, n.left, n.left + n.width) &&
                    s._isBetween(e, n.top, n.top + n.height))
                )
          ...
          handleEvent(t) {
            ...
            } else i && s.callback(e.onClick, [t, i, this], this);
            var n, o;
          }
        }
        function di(t, e) {
        ...
        var ui = {
          ...
          _element: ci,
          start(t, e, i) {
            const s = (t.legend = new ci({ ctx: t.ctx, options: i, chart: t }));
            rt.configure(t, s, i), rt.addBox(t, s);
          },
          stop(t) {
            rt.removeBox(t, t.legend), delete t.legend;
          },
          beforeUpdate(t, e, i) {
            const s = t.legend;
            rt.configure(t, s, i), (s.options = i);
          },
          afterUpdate(t) {
            const e = t.legend;
        ...
        class fi extends Pt {
          ...
          _drawArgs(t) {
            ...
            return (
              this.isHorizontal()
                ? ((h = s._alignStartEnd(r, i, o)), (c = e + t), (l = o - i))
                : ("left" === a.position
                    ? ((h = i + t),
        ...
        var gi = {
          ...
          start(t, e, i) {
            !(function (t, e) {
              const i = new fi({ ctx: t.ctx, options: e, chart: t });
              rt.configure(t, i, e), rt.addBox(t, i), (t.titleBlock = i);
            })(t, i);
          },
          stop(t) {
            const e = t.titleBlock;
            rt.removeBox(t, e), delete t.titleBlock;
          },
          beforeUpdate(t, e, i) {
        ...
        var mi = {
          id: "subtitle",
          start(t, e, i) {
            const s = new fi({ ctx: t.ctx, options: i, chart: t });
            rt.configure(t, s, i), rt.addBox(t, s), pi.set(t, s);
          },
          stop(t) {
            rt.removeBox(t, pi.get(t)), pi.delete(t);
          },
          beforeUpdate(t, e, i) {
            const s = pi.get(t);
            rt.configure(t, s, i), (s.options = i);
        ...
        function xi(t, e) {
          return (
            e && (s.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
          );
        }
        function _i(t) {
        ...
        function vi(t, e) {
          ...
          if (
            ...
            m +=
              g * (e.displayColors ? Math.max(l, h.lineHeight) : h.lineHeight) +
              (x - g) * h.lineHeight +
              (x - 1) * e.bodySpacing;
          }
          f &&
            (m +=
              e.footerMarginTop + f * d.lineHeight + (f - 1) * e.footerSpacing);
          let _ = 0;
          const y = function (t) {
          ...
          return (
            ...
            s.each(n, (t) => {
              s.each(t.before, y), s.each(t.lines, y), s.each(t.after, y);
            }),
            (_ = 0),
            (i.font = d.string),
            s.each(t.footer, y),
        ...
        function wi(t, e, i) {
          ...
          return { xAlign: i.xAlign || e.xAlign || Mi(t, e, i, s), yAlign: s };
        }
        function Si(t, e, i, n) {
        ...
        const Oi = {
          ...
          label(t) {
            ...
            return s.isNullOrUndef(i) || (e += i), e;
          },
          labelColor(t) {
            const e = t.chart
        ...
        class Ai extends Pt {
          ...
          getTitle(t, e) {
            ...
            let a = [];
            return (
              (a = xi(a, _i(s))), (a = xi(a, _i(n))), (a = xi(a, _i(o))), a
            );
          }
          getBeforeBody(t, e) {
            ...
            return (
              s.each(t, (t) => {
                const e = { before: [], lines: [], after: [] },
                  s = Ci(i, t);
                xi(e.before, _i(Di(s, "beforeLabel", this, t))),
                  xi(e.lines, Di(s, "label", this, t)),
                  xi(e.after, _i(Di(s, "afterLabel", this, t))),
                  n.push(e);
              }),
              n
            );
          ...
          _createItems(t) {
            ...
            let r,
              l,
              h = [];
            for (r = 0, l = e.length; r < l; ++r) h.push(yi(this.chart, e[r]));
            return (
          ...
          update(t, e) {
            ...
            let n,
              o = [];
            if (s.length) {
              const t = bi[i.position].call(this, s, this._eventPosition);
              ...
              const e = (this._size = vi(this, i)),
                a = Object.assign({}, t, e),
                r = wi(this.chart, i, a),
                l = Si(i, a, r, this.chart);
          ...
          getCaretPosition(t, e, i) {
            ...
            return (
              "center" === o
                ? ((y = f + p / 2),
                  "left" === n
                    ? ((m = u), (b = m - a), (_ = y + a), (v = y - a))
                    : ((m = u + g), (b = m + a), (_ = y - a), (v = y + a)),
                  (x = m))
                : ((b =
                    "left" === n
                      ? u + Math.max(l, c) + a
                      ...
                      : this.caretX),
                  "top" === o
                    ? ((_ = f), (y = _ - a), (m = b - a), (x = b + a))
                    : ((_ = f + p), (y = _ + a), (m = b + a), (x = b - a)),
                  (v = _)),
              { x1: m, x2: b, x3: x, y1: _, y2: y, y3: v }
            );
          }
          drawTitle(t, e, i) {
            const n = this.title,
          ...
          _drawColorBox(t, e, i, n, o) {
            ...
            if (o.usePointStyle) {
              ...
              (t.lineWidth = s.isObject(a.borderWidth)
          ...
          drawBody(t, e, i) {
            ...
            const g = s.getRtlAdapter(i.rtl, this.x, this.width),
              p = function (i) {
                e.fillText(i, g.x(t.x + f), t.y + u / 2), (t.y += u + o);
              },
              m = g.textAlign(a);
            let b, x, _, y, v, M, w;
            for (
              ...
              for (
                ...
                p(_[v]), (u = d.lineHeight);
              s.each(b.after, p);
            }
            (f = 0), (u = d.lineHeight), s.each(this.afterBody, p), (t.y -= o);
          }
          drawFooter(t, e, i) {
            const n = this.footer,
              o = n.length;
          ...
          drawBackground(t, e, i, n) {
            const { xAlign: o, yAlign: a } = this,
              ...
              { width: h, height: c } = i,
              {
                ...
                bottomLeft: f,
                bottomRight: g,
              } = s.toTRBLCorners(n.cornerRadius);
          ...
          _updateAnimationTarget(t) {
            const e = this.chart,
              ...
              n = i && i.y;
            if (s || n) {
              const i = bi[t.position].call(
                this,
                this._active,
                this._eventPosition
              );
              if (!i) return;
              const o = (this._size = vi(this, t)),
        ...
        var Ti = {
            ...
            positioners: bi,
            afterInit(t, e, i) {
              i && (t.tooltip = new Ai({ chart: t, options: i }));
            },
            beforeUpdate(t, e, i) {
                ...
                isFinite(e) && i[e] === t
                  ...
                  : (function (t, e, i, s) {
                      ...
                      return -1 === n
                        ...
                        ? i
                        : n;
                    })(i, t, s.valueOrDefault(e, t), this._addedLabels)),
              ((t, e) =>
                null === t ? null : s._limitValue(Math.round(t), 0, e))(
                e,
                i.length - 1
              )
            );
        ...
        function Fi(t, e, { horizontal: i, minRotation: n }) {
          const o = s.toRadians(n),
          ...
          buildTicks() {
            ...
            const n = (function (t, e) {
              ...
              let v,
                ...
                w,
                S,
                k = s.niceNum((m - p) / g / f) * f;
              if (k < 1e-14 && !b && !x) return [{ value: p }, { value: m }];
              (S = Math.ceil(m / k) - Math.floor(p / k)),
                S > g && (k = s.niceNum((S * k) / g / f) * f),
                s.isNullOrUndef(l) ||
                  ((v = Math.pow(10, l)), (k = Math.ceil(k * v) / v)),
                "ticks" === n
                  ? ((M = Math.floor(p / k) * k), (w = Math.ceil(m / k) * k))
                  : ((M = p), (w = m)),
                b && x && o && s.almostWhole((r - a) / o, k / 1e3)
                  ? ((S = Math.round(Math.min((r - a) / k, c))),
                    (k = (r - a) / S),
                    (M = a),
                    (w = r))
                  : _
                  ? ((M = b ? a : M),
                    ...
                    (k = (w - M) / S))
                  : ((S = (w - M) / k),
                    (S = s.almostEquals(S, Math.round(S), k / 1e3)
                      ? Math.round(S)
                      : Math.ceil(S)));
              const P = Math.max(s._decimalPlaces(k), s._decimalPlaces(M));
              (v = Math.pow(10, s.isNullOrUndef(l) ? P : l)),
                (M = Math.round(M * v) / v),
                (w = Math.round(w * v) / v);
              let C = 0;
              for (
                ...
                i.push({ value: Math.round((M + C * k) * v) / v });
              return (
                x && u && w !== r
                  ? i.length &&
                    s.almostEquals(i[i.length - 1].value, r, Fi(r, y, t))
            ...
            return (
              "ticks" === t.bounds && s._setMinAndMaxByKey(n, this, "value"),
              t.reverse
        ...
        class Bi extends Ni {
          static id = "linear";
          static defaults = { ticks: { callback: s.Ticks.formatters.numeric } };
          determineDataLimits() {
        ...
        const zi = (t) => Math.floor(s.log10(t)),
          Vi = (t, e) => Math.pow(10, zi(t) + e);
        function ji(t) {
          return 1 === t / Math.pow(10, zi(t));
        }
        function Hi(t, e, i) {
        ...
        function Wi(t, { min: e, max: i }) {
          e = s.finiteOrDefault(t.min, e);
          const n = [],
            o = zi(e);
          let a = (function (t, e) {
              let i = zi(e - t);
              for (; Hi(t, e, i) > 10; ) i++;
              for (; Hi(t, e, i) < 10; ) i--;
              return Math.min(i, zi(t));
            })(e, i),
            r = a < 0 ? Math.pow(10, Math.abs(a)) : 1;
          const l = Math.pow(10, a),
            h = o > a ? Math.pow(10, o) : 0,
            c = Math.round((e - h) * r) / r,
            d = Math.floor((e - h) / l / 10) * l * 10;
          let u = Math.floor((c - d) / Math.pow(10, a)),
            f = s.finiteOrDefault(
              t.min,
              Math.round((h + d + u * Math.pow(10, a)) * r) / r
            );
          for (; f < i; )
            n.push({ value: f, major: ji(f), significand: u }),
              u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
              u >= 20 && (a++, (u = 2), (r = a >= 0 ? 1 : r)),
              (f = Math.round((h + d + u * Math.pow(10, a)) * r) / r);
          const g = s.finiteOrDefault(t.max, f);
          return n.push({ value: g, major: ji(g), significand: u }), n;
        }
        class Ui extends Nt {
          ...
          parse(t, e) {
            const i = Ni.prototype.parse.apply(this, [t, e]);
            if (0 !== i) return s.isNumberFinite(i) && i > 0 ? i : null;
            this._zero = !0;
          }
          determineDataLimits() {
            const { min: t, max: e } = this.getMinMax(!0);
            (this.min = s.isNumberFinite(t) ? Math.max(0, t) : null),
              ...
              this._zero &&
                ...
                !s.isNumberFinite(this._userMin) &&
                (this.min =
                  t === Vi(this.min, 0) ? Vi(this.min, -1) : Vi(this.min, 0)),
              this.handleTickRangeOptions();
          }
          handleTickRangeOptions() {
            const { minDefined: t, maxDefined: e } = this.getUserBounds();
            ...
            const n = (e) => (i = t ? i : e),
              o = (t) => (s = e ? s : t);
            i === s && (i <= 0 ? (n(1), o(10)) : (n(Vi(i, -1)), o(Vi(s, 1)))),
              i <= 0 && n(Vi(s, -1)),
              s <= 0 && o(Vi(i, 1)),
              (this.min = i),
              (this.max = s);
          ...
          buildTicks() {
            const t = this.options,
              e = Wi({ min: this._userMin, max: this._userMax }, this);
            return (
              "ticks" === t.bounds && s._setMinAndMaxByKey(e, this, "value"),
              t.reverse
            ...
            return (
              ...
              null === t || isNaN(t)
                ...
                : this.getPixelForDecimal(
                    t === this.min
                      ? 0
                      : (s.log10(t) - this._startValue) / this._valueRange
                  )
            );
          }
          getValueForPixel(t) {
        ...
        function $i(t) {
          ...
          if (e.display && t.display) {
            ...
            return (
              s.valueOrDefault(e.font && e.font.size, s.defaults.font.size) +
              t.height
            );
          }
          return 0;
        ...
        function Yi(t) {
          ...
          for (let u = 0; u < a; u++) {
            ...
            Ki(i, e, m, Gi(b, f.x, p.w, 0, 180), Gi(b, f.y, p.h, 90, 270));
          }
          var h, c, d;
            ...
            (t._pointLabelItems = (function (t, e, i) {
              ...
              for (let a = 0; a < o; a++) {
                const o = t.getPointPosition(a, l + r + i[a], h),
                  c = Math.round(
                    s.toDegrees(s._normalizeAngle(o.angle + s.HALF_PI))
                  ),
                  d = e[a],
                  u = Zi(o.y, d.h, c),
                  f = Xi(c),
        ...
        function Ji(t, e, i, n) {
          const { ctx: o } = t;
          if (i) o.arc(t.xCenter, t.yCenter, e, 0, s.TAU);
          else {
        ...
        class Qi extends Ni {
          ...
          setDimensions() {
            const t = (this._padding = s.toPadding($i(this.options) / 2)),
                ...
                (function (t, e) {
                  ...
                  for (let o = e - 1; o >= 0; o--) {
                    ...
                    s.renderText(
                      ...
                      l + a.lineHeight / 2,
                      a,
                      { color: e.color, textAlign: h, textBaseline: "middle" }
                    );
                  }
                })(this, a),
              n.display &&
          ...
          drawLabels() {
            ...
            t.save(),
              ...
              this.ticks.forEach((n, r) => {
                ...
                s.renderText(t, n.label, 0, -o, h, { color: l.color });
              }),
              t.restore();
          }
          drawTitle() {}
        ...
        function ss(t, e) {
          if (s.isNullOrUndef(e)) return null;
          const i = t._adapter,
        ...
        function ns(t, e, i, s) {
          const n = es.length;
          for (let o = es.indexOf(t); o < n - 1; ++o) {
            const t = ts[es[o]],
        ...
        class rs extends Nt {
          ...
          init(t, e = {}) {
            const i = t.time || (t.time = {}),
              n = (this._adapter = new j._date(t.adapters.date));
            n.init(e),
          ...
          parse(t, e) {
            return void 0 === t ? null : ss(this, t);
          }
          beforeLayout() {
            super.beforeLayout(),
              (this._cache = { data: [], labels: [], all: [] });
          ...
          determineDataLimits() {
            ...
            (a && r) ||
              ...
              ("ticks" === t.bounds && "labels" === t.ticks.source) ||
                l(this.getMinMax(!1))),
              (n =
                s.isNumberFinite(n) && !isNaN(n)
                  ? n
                  : +e.startOf(Date.now(), i)),
              (o =
                s.isNumberFinite(o) && !isNaN(o)
                  ? o
          ...
          buildTicks() {
            ...
            return (
              (this._unit =
                e.unit ||
                (i.autoSkip
                  ? ns(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
                  : (function (t, e, i, s, n) {
                      for (let o = es.length - 1; o >= es.indexOf(i); o--) {
                        const i = es[o];
                        if (ts[i].common && t._adapter.diff(n, s, i) >= e - 1)
                          return i;
                      }
                      return es[i ? es.indexOf(i) : 0];
                    })(this, r.length, e.minUnit, this.min, this.max))),
              (this._majorUnit =
                i.major.enabled && "year" !== this._unit
                  ? (function (t) {
                      for (let e = es.indexOf(t) + 1, i = es.length; e < i; ++e)
                        if (ts[es[e]].common) return es[e];
                    })(this._unit)
                  : void 0),
              this.initOffsets(n),
              t.reverse && r.reverse(),
              as(this, r, this._majorUnit)
            );
          }
          afterAutoSkip() {
          ...
          _generate() {
            const t = this._adapter,
              ...
              n = this.options,
              o = n.time,
              a = o.unit || ns(o.minUnit, e, i, this._getLabelCapacity(e)),
            ...
            for (d = f, u = 0; d < i; d = +t.add(d, r, a), u++) os(c, d, g);
            return (
              (d !== i && "ticks" !== n.bounds && 1 !== u) || os(c, d, g),
              Object.keys(c)
                .sort((t, e) => t - e)
                .map((t) => +t)
            );
          ...
          _tickFormatFunction(t, e, i, n) {
            const o = this.options,
              a = o.ticks.callback;
            if (a) return s.callback(a, [t, e, i], this);
          ...
          getDataTimestamps() {
            ...
            if (this._normalized && s.length)
              return (this._cache.data = s[0].controller.getAllParsedValues(
                this
              ));
          ...
          getLabelTimestamps() {
            ...
            for (e = 0, i = s.length; e < i; ++e) t.push(ss(this, s[e]));
            return (this._cache.labels = this._normalized
              ? t
              : this.normalize(t));
          }
          normalize(t) {
            return s._arrayUnique(t.sort(is));
          }
        }
        function ls(t, e, i) {
          let n,
          ...
          i
            ? (e >= t[l].pos &&
                e <= t[h].pos &&
                ({ lo: l, hi: h } = s._lookupByKey(t, "pos", e)),
              ({ pos: n, time: a } = t[l]),
              ({ pos: o, time: r } = t[h]))
            : (e >= t[l].time &&
                e <= t[h].time &&
                ({ lo: l, hi: h } = s._lookupByKey(t, "time", e)),
              ({ time: n, pos: a } = t[l]),
              ({ time: o, pos: r } = t[h]));
          const c = o - n;
        ...
        class hs extends rs {
          ...
          initOffsets() {
            ...
            (this._minPos = ls(e, this.min)),
              (this._tableRange = ls(e, this.max) - this._minPos),
              super.initOffsets(t);
          }
          buildLookupTable(t) {
          ...
          getDecimalForValue(t) {
            return (ls(this._table, t) - this._minPos) / this._tableRange;
          }
          getValueForPixel(t) {
            const e = this._offsets,
              i = this.getDecimalForPixel(t) / e.factor - e.end;
            return ls(this._table, i * this._tableRange + this._minPos, !0);
          }
        }
        ...
        (e.Ticks = s.Ticks),
          ...
          (e.Chart = ce),
          (e.Colors = He),
          (e.DatasetController = v),
          (e.Decimation = $e),
          (e.DomPlatform = St),
          (e.DoughnutController = L),
          (e.Element = Pt),
          (e.Filler = li),
          (e.Interaction = K),
          (e.Legend = ui),
          ...
          (e.LineElement = ke),
          (e.LinearScale = Bi),
          (e.LogarithmicScale = Ui),
          (e.PieController = I),
          (e.PointElement = Ce),
          (e.PolarAreaController = E),
          (e.RadarController = F),
          (e.RadialLinearScale = Qi),
          (e.Scale = Nt),
          (e.ScatterController = N),
          (e.SubTitle = mi),
          (e.TimeScale = rs),
          (e.TimeSeriesScale = hs),
          (e.Title = gi),
          (e.Tooltip = Ti),
          (e._adapters = j),
          (e._detectPlatform = kt),
          (e.animator = o),
          (e.controllers = B),
          (e.elements = Ie),
          (e.layouts = rt),
      ...
      "../node_modules/chart.js/dist/chunks/helpers.segment.cjs": (t, e, i) => {
        "use strict";
        var s = i("../node_modules/@kurkle/color/dist/color.cjs");
        const n = (() => {
          let t = 0;
          return () => t++;
        })();
        ...
        function g(t, e, i) {
          ...
          let l;
          for (let e = 0; e < n; ++e) {
            if (((l = s[e]), !r(l))) continue;
            const n = Object.keys(l);
            for (let e = 0, s = n.length; e < s; ++e) o(n[e], t, l, i);
          }
          return t;
        }
        function p(t, e) {
          return g(t, e, { merger: m });
        }
        function m(t, e, i) {
          if (!u(t)) return;
          const s = e[t],
          ...
          r(s) && r(n)
            ? p(s, n)
            : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = d(n));
        }
        const b = { "": (t) => t, x: (t) => t.x, y: (t) => t.y };
        function x(t) {
          const e = t.split("."),
            i = [];
          let s = "";
        ...
        const U = (t) => 0 === t || 1 === t,
          $ = (t, e, i) =>
            -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * S) / i),
          G = (t, e, i) =>
            Math.pow(2, -10 * t) * Math.sin(((t - e) * S) / i) + 1,
          Y = {
            linear: (t) => t,
            easeInQuad: (t) => t * t,
            easeOutQuad: (t) => -t * (t - 2),
            ...
            easeInElastic: (t) => (U(t) ? t : $(t, 0.075, 0.3)),
            easeOutElastic: (t) => (U(t) ? t : G(t, 0.075, 0.3)),
            easeInOutElastic(t) {
              const e = 0.1125;
              return U(t)
                ? t
            ...
            easeInBounce: (t) => 1 - Y.easeOutBounce(1 - t),
            easeOutBounce(t) {
              const e = 7.5625,
                i = 2.75;
              return t < 1 / i
            ...
            easeInOutBounce: (t) =>
              t < 0.5
                ? 0.5 * Y.easeInBounce(2 * t)
                : 0.5 * Y.easeOutBounce(2 * t - 1) + 0.5,
          };
        function K(t) {
        ...
        function X(t) {
          return K(t)
            ? t
            : new s.Color(t).saturate(0.5).darken(0.1).hexString();
        }
        const q = ["x", "y", "borderWidth", "radius", "tension"],
          Z = ["color", "borderColor", "backgroundColor"];
        const J = new Map();
        function Q(t, e, i) {
          return (function (t, e) {
            e = e || {};
            ...
            let s = J.get(i);
            return s || ((s = new Intl.NumberFormat(t, e)), J.set(i, s)), s;
          })(e, i).format(t);
        }
        const tt = {
          values: (t) => (a(t) ? t : "" + t),
          numeric(t, e, i) {
            ...
            return Object.assign(l, this.options.ticks.format), Q(t, s, l);
          },
          logarithmic(t, e, i) {
            if (0 === t) return "0";
            const s = i[e].significand || t / Math.pow(10, Math.floor(T(t)));
            return [1, 2, 3, 5, 10, 15].includes(s) || e > 0.8 * i.length
              ? tt.numeric.call(this, t, e, i)
              : "";
          },
        };
        var et = { formatters: tt };
          ...
          [
            function (t) {
              t.set("animation", {
                ...
                t.set("animations", {
                  colors: { type: "color", properties: Z },
                  numbers: { type: "number", properties: q },
                }),
        ...
        function ct(t, e, i, s, n) {
          ...
          if (!(isNaN(p) || p <= 0)) {
            switch ((t.beginPath(), f)) {
              default:
                n ? t.ellipse(i, s, n / 2, p, 0, 0, S) : t.arc(i, s, p, 0, S),
                  t.closePath();
                break;
              case "triangle":
                (c = n ? n / 2 : p),
              ...
              case "rectRounded":
                (h = 0.516 * p),
                  (l = p - h),
                  (a = Math.cos(m + D) * l),
                  (d = Math.cos(m + D) * (n ? n / 2 - h : l)),
                  (r = Math.sin(m + D) * l),
                  (u = Math.sin(m + D) * (n ? n / 2 - h : l)),
                  t.arc(i - d, s - r, h, m - w, m - O),
                  t.arc(i + u, s - a, h, m - O, m),
                  t.arc(i + d, s + r, h, m, m + O),
                  t.arc(i - u, s + a, h, m + O, m + w),
                  t.closePath();
                break;
              case "rect":
                if (!g) {
        ...
        function xt(t, e) {
          ...
          for (const t of n) i[t] = bt(o(t));
          return i;
        }
        function _t(t) {
          return xt(t, { top: "y", right: "x", bottom: "y", left: "x" });
        }
        function yt(t, e) {
          return Object.assign(Object.create(t), e);
        }
        function vt(t, e = [""], i = t, s, n = () => t[0]) {
          v(s) || (s = Lt("_fallback", t));
          const o = {
            ...
            get: (i, s) =>
              Pt(i, s, () =>
                (function (t, e, i, s) {
                  let n;
                  for (const o of e)
                    if (((n = Lt(St(o, t), i)), v(n)))
                      return kt(t, n) ? At(i, s, t, n) : n;
                })(s, e, t, i)
              ),
            getOwnPropertyDescriptor: (t, e) =>
              Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
            getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
            has: (t, e) => Rt(t).includes(e),
            ownKeys: (t) => Rt(t),
            set(t, e, i) {
        ...
        function Mt(t, e, i, s) {
          const n = {
            ...
            _stack: new Set(),
            _descriptors: wt(t, s),
            setContext: (e) => Mt(t, e, i, s),
            override: (n) => Mt(t.override(n), e, i, s),
          };
          return new Proxy(n, {
                ...
                (function (t, e, i) {
                  ...
                  a(h) &&
                    ...
                    (h = (function (t, e, i, s) {
                      ...
                      if (v(o.index) && s(t)) e = e[o.index % e.length];
                      else if (r(e[0])) {
                        const i = e,
                        ...
                        for (const r of i) {
                          const i = At(s, n, t, r);
                          e.push(Mt(i, o, a && a[t], l));
                        }
                      }
                      return e;
                    })(e, h, t, l.isIndexable));
                  kt(e, h) && (h = Mt(h, n, o && o[e], l));
                  return h;
                })(t, e, i)
              ),
        ...
        function wt(t, e = { scriptable: !0, indexable: !0 }) {
          const {
        ...
        const Ot = (t, e) =>
          !0 === t ? e : "string" == typeof t ? _(e, t) : void 0;
        function Dt(t, e, i, s, n) {
          for (const o of e) {
            const e = Ot(i, o);
            if (e) {
              t.add(e);
              const o = Ct(e._fallback, i, n);
              if (v(o) && o !== i && o !== s) return o;
            } else if (!1 === e && v(s) && i !== s) return null;
          }
          return !1;
        }
        function At(t, e, i, s) {
          const n = e._rootScopes,
            o = Ct(e._fallback, i, s),
            l = [...t, ...n],
            h = new Set();
          h.add(s);
          ...
          !(function (t, e, i) {
            ...
            (function (t, e, i = "x") {
              ...
              let o,
                ...
                l = It(t, 0);
              for (let h = 0; h < n; ++h) {
                if (((a = r), (r = l), (l = It(t, h + 1)), !r)) continue;
                const n = r[i],
                  c = r[s];
                a &&
                  ((o = (n - a[i]) / 3),
        ...
        const Ht = (t) => t.ownerDocument.defaultView.getComputedStyle(t, null);
        function Wt(t, e) {
          return Ht(t).getPropertyValue(e);
        }
        ...
        const Gt = (t, e, i) => (t > 0 || e > 0) && (!i || !i.shadowRoot);
        const Yt = (t) => Math.round(10 * t) / 10;
        const Kt = (function () {
          let t = !1;
          try {
            const e = {
        ...
        function Jt(t) {
          return "angle" === t
            ? { between: N, compare: I, normalize: F }
            : { between: z, compare: (t, e) => t - e, normalize: (t) => t };
        }
        function Qt({ start: t, end: e, count: i, loop: s, style: n }) {
          return {
            start: t % i,
            end: e % i,
            loop: s && (e - t + 1) % i == 0,
        ...
        function te(t, e, i) {
          ...
          const { property: s, start: n, end: o } = i,
            a = e.length,
            { compare: r, between: l, normalize: h } = Jt(s),
            { start: c, end: d, loop: u, style: f } = (function (t, e, i) {
              const { property: s, start: n, end: o } = i,
                { between: a, normalize: r } = Jt(s),
                l = e.length;
              let h,
                c,
              ...
              m.skip ||
                ...
                p !== b &&
                  ...
                  null !== _ &&
                    v() &&
                    (g.push(
                      Qt({ start: _, end: t, loop: u, count: a, style: f })
                    ),
                    (_ = null)),
                  (i = t),
                  (b = p)));
          return (
            null !== _ &&
              g.push(Qt({ start: _, end: d, loop: u, count: a, style: f })),
            g
          );
        }
        function ee(t, e, i, s) {
        ...
        (e.HALF_PI = O),
          ...
          (e.TWO_THIRDS_PI = A),
          (e.Ticks = et),
          (e._addGrace = function (t, e, i) {
            const { min: s, max: n } = t,
              o = c(e, (n - s) / 2),
              a = (t, e) => (i && 0 === t ? 0 : t + e);
            return { min: a(s, -Math.abs(o)), max: a(n, o) };
          }),
          (e._alignPixel = function (t, e, i) {
            const s = t.currentDevicePixelRatio,
              n = 0 !== i ? Math.max(i / 2, 0.5) : 0;
            return Math.round((e - n) * s) / s + n;
          }),
          (e._alignStartEnd = (t, e, i) =>
            "start" === t ? e : "end" === t ? i : (e + i) / 2),
          (e._angleBetween = N),
          (e._angleDiff = I),
          (e._arrayUnique = function (t) {
            const e = new Set();
            let i, s;
          ...
          (e._attachContext = Mt),
          (e._bezierCurveTo = function (t, e, i, s) {
          ...
          (e._bezierInterpolation = function (t, e, i, s) {
          ...
          (e._capitalize = y),
          (e._computeSegments = function (t, e) {
            const i = t.points,
          ...
          (e._createResolver = vt),
          (e._decimalPlaces = function (t) {
            if (!l(t)) return;
            let e = 1,
              i = 0;
          ...
          (e._deprecated = function (t, e, i, s) {
            void 0 !== e &&
              console.warn(
                t +
                  ': "' +
          ...
          (e._filterBetween = function (t, e, i) {
            let s = 0,
              n = t.length;
            for (; s < n && t[s] < e; ) s++;
            for (; n > s && t[n - 1] > i; ) n--;
          ...
          (e._getParentNode = Vt),
          (e._getStartAndCountOfVisiblePoints = function (t, e, i) {
            const s = e.length;
            let n = 0,
              o = s;
            if (t._sorted) {
              ...
              d &&
                (n = B(
                  Math.min(
                    j(r, a.axis, h).lo,
                    i ? s : j(e, l, a.getPixelForValue(h)).lo
                  ),
                  0,
                  s - 1
                )),
                (o = u
                  ? B(
                      Math.max(
                        j(r, a.axis, c, !0).hi + 1,
                        i ? 0 : j(e, l, a.getPixelForValue(c), !0).hi + 1
                      ),
                      n,
                      s
                    ) - n
          ...
          (e._int16Range = function (t) {
            return B(t, -32768, 32767);
          }),
          (e._isBetween = z),
          (e._isClickEvent = function (t) {
            return (
              "mouseup" === t.type ||
              "click" === t.type ||
              "contextmenu" === t.type
          ...
          (e._isPointInArea = dt),
          (e._limitValue = B),
          (e._longestText = function (t, e, i, s) {
            ...
            let h, c, d, u, f;
            for (h = 0; h < l; h++)
              if (((u = i[h]), null != u && !0 !== a(u))) r = ht(t, n, o, r, u);
              else if (a(u))
                for (c = 0, d = u.length; c < d; c++)
                  (f = u[c]), null == f || a(f) || (r = ht(t, n, o, r, f));
            t.restore();
            const g = o.length / 2;
            if (g > i.length) {
              for (h = 0; h < g; h++) delete n[o[h]];
              o.splice(0, g);
            }
            return r;
          }),
          ...
          (e._mergerIf = m),
          (e._normalizeAngle = F),
          (e._parseObjectDataRadialScale = function (t, e, i, s) {
            const { iScale: n } = t,
              { key: o = "r" } = this._parsing,
              a = new Array(s);
            let r, l, h, c;
            for (r = 0, l = s; r < l; ++r)
              (h = r + i), (c = e[h]), (a[r] = { r: n.parse(_(c, o), h) });
            return a;
          }),
          (e._pointInLine = Xt),
          (e._readValueToProps = xt),
          (e._rlookupByKey = (t, e, i) => V(t, i, (s) => t[s][e] >= i)),
          (e._scaleRangesChanged = function (t) {
          ...
          (e._setMinAndMaxByKey = function (t, e, i) {
            let s, n, o;
            for (s = 0, n = t.length; s < n; s++)
              (o = t[s][i]),
                isNaN(o) ||
          ...
          (e._splitKey = x),
          (e._steppedInterpolation = function (t, e, i, s) {
            return {
              x: t.x + i * (e.x - t.x),
              y:
                "middle" === s
          ...
          (e._steppedLineTo = function (t, e, i, s, n) {
            if (!e) return t.lineTo(i.x, i.y);
            if ("middle" === n) {
              const s = (e.x + i.x) / 2;
          ...
          (e._textX = (t, e, i, s) =>
            t === (s ? "left" : "right")
              ...
              ? (e + i) / 2
              : e),
          (e._toLeftRightCenter = (t) =>
            "start" === t ? "left" : "end" === t ? "right" : "center"),
          (e._updateBezierControlPoints = function (t, e, i, s, n) {
            let o, a, r, l;
            if (
                ...
                for (i = 0, s = t.length; i < s; ++i)
                  (a = o),
                    ...
                    o &&
                      ((n = t[i]),
                      a &&
                        ((n.cp1x = zt(n.cp1x, e.left, e.right)),
                        (n.cp1y = zt(n.cp1y, e.top, e.bottom))),
                      r &&
                        ((n.cp2x = zt(n.cp2x, e.left, e.right)),
                        (n.cp2y = zt(n.cp2y, e.top, e.bottom))));
              })(t, i);
          }),
          (e.addRoundedRectPath = function (t, e) {
            const { x: i, y: s, w: n, h: o, radius: a } = e;
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, -O, w, !0),
              ...
              t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -O, !0),
              t.lineTo(i + a.topLeft, s);
          }),
          (e.almostEquals = R),
          (e.almostWhole = function (t, e) {
            const i = Math.round(t);
            return i - e <= t && i + e >= t;
          }),
          (e.callback = function (t, e, i) {
          ...
          (e.defined = v),
          (e.descriptors = st),
          (e.distanceBetweenPoints = E),
          (e.drawPoint = function (t, e, i, s) {
            ct(t, e, i, s, null);
          }),
          (e.drawPointLegend = ct),
          (e.each = function (t, e, i, s) {
            let n, o, l;
            if (a(t))
              if (((o = t.length), s))
              ...
              for (l = Object.keys(t), o = l.length, n = 0; n < o; n++)
                e.call(i, t[l[n]], l[n]);
          }),
          (e.effects = Y),
          (e.finiteOrDefault = function (t, e) {
            return l(t) ? t : e;
          }),
          ...
          (e.getAngleFromPoint = function (t, e) {
            ...
            return o < -0.5 * w && (o += S), { angle: o, distance: n };
          }),
          (e.getHoverColor = X),
          (e.getMaximumSize = function (t, e, i, s) {
            const n = Ht(t),
              o = $t(n, "margin"),
              a = jt(n.maxWidth, t, "clientWidth") || P,
              r = jt(n.maxHeight, t, "clientHeight") || P,
              l = (function (t, e, i) {
                let s, n;
                if (void 0 === e || void 0 === i) {
                  ...
                  if (o) {
                    ...
                    (e = t.width - l.width - r.width),
                      ...
                      (s = jt(a.maxWidth, o, "clientWidth")),
                      (n = jt(a.maxHeight, o, "clientHeight"));
            ...
            return (
              ...
              (h = Yt(Math.min(h, a, l.maxWidth))),
              (c = Yt(Math.min(c, r, l.maxHeight))),
              h && !c && (c = Yt(h / 2)),
              (void 0 !== e || void 0 !== i) &&
                s &&
                l.height &&
                c > l.height &&
                ((c = l.height), (h = Yt(Math.floor(c * s)))),
              { width: h, height: c }
            );
          }),
          (e.getRelativePosition = function (t, e) {
          ...
          (e.getRtlAdapter = function (t, e, i) {
            return t ? qt(e, i) : Zt();
          }),
          (e.getStyle = Wt),
          (e.isArray = a),
          ...
          (e.isNumberFinite = l),
          (e.isObject = r),
          (e.isPatternOrGradient = K),
          (e.listenArrayEvents = function (t, e) {
            t._chartjs
          ...
          (e.noop = function () {}),
          (e.overrideTextDirection = function (t, e) {
            let i, s;
            ("ltr" !== e && "rtl" !== e) ||
              ((i = t.canvas.style),
              (s = [
          ...
          (e.overrides = it),
          (e.readUsedSize = function (t, e) {
            const i = Wt(t, e),
              s = i && i.match(/^(\d+)(\.\d+)?px$/);
            return s ? +s[1] : void 0;
          }),
          (e.renderText = function (t, e, i, s, n, r = {}) {
            const l = a(e) ? e : [e],
          ...
          (e.resolveObjectKey = _),
          (e.restoreTextDirection = function (t, e) {
            void 0 !== e &&
              (delete t.prevTextDirection,
              t.canvas.style.setProperty("direction", e[0], e[1]));
          }),
          (e.retinaScale = function (t, e, i) {
            const s = e || 1,
          ...
          (e.sign = L),
          (e.splineCurve = Nt),
          (e.splineCurveMonotone = Bt),
          (e.supportsEventListenerOptions = Kt),
          (e.throttled = function (t, e) {
            let i = [],
              s = !1;
            return function (...n) {
              (i = n),
          ...
          (e.toFont = function (t, e) {
            ...
            return (n.string = lt(n)), n;
          }),
          (e.toFontString = lt),
          (e.toLineHeight = mt),
          (e.toPadding = function (t) {
            const e = _t(t);
            return (
              (e.width = e.left + e.right), (e.height = e.top + e.bottom), e
            );
          }),
          (e.toPercentage = (t, e) =>
            "string" == typeof t && t.endsWith("%")
          ...
          (e.unlistenArrayEvents = function (t, e) {
            const i = t._chartjs;
            if (!i) return;
            const s = i.listeners,
              n = s.indexOf(e);
  ...
  })("./src/website/Scripts/Typescript/index/fpage.ts");
})();
