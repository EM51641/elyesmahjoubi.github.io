...
!(function (t, e) {
  ...
  class Bs extends Ds {
    ...
    drawTitle() {
      ...
      "bottom" === e || "center" === e || U(e)
        ...
        : (l += a.top);
      const { titleX: h, titleY: c, maxWidth: d, rotation: u } = (function (
        t,
        e,
        i,
        s
  ...
  function Fn(t, e, i, s, n) {
    ...
    const g = (f - Math.max(0.001, f * c - i / _t) / c) / 2,
      p = r + g + u,
      m = n - g - u,
      { outerStart: x, outerEnd: b, innerStart: _, innerEnd: y } = In(
        e,
        d,
        c,
        m - p
  ...
  class $o extends Ds {
    ...
    drawBackground(t, e, i, s) {
      const { xAlign: n, yAlign: o } = this,
        { x: a, y: r } = t,
        { width: l, height: h } = i,
        { topLeft: c, topRight: d, bottomLeft: u, bottomRight: f } = We(
          s.cornerRadius
        );
